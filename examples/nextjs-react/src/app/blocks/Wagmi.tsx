		...
		<AppBlock
			...
			description={
				<>
					...
					<strong>useConnect()</strong> hook. While it&apos;s a quite standard
					UX approach in the Ethereum ecosystem, this is not ideal when working
					with lists of multiple accounts and wallets.
					<br />
				</>
			}
			codeUrl="https://github.com/kheopskit/kheopskit/blob/main/examples/nextjs-react/src/app/blocks/Wagmi.tsx"
		>
	...
	return (
		<div>
			...
			<p className="text-muted-foreground text-sm">
				It&apos;s bad UX to have to switch the active Wagmi connector prior to
				do an action with it, as it can trigger wallet prompts.
				<br />
				When doing an action using an account from the Kheopskit accounts list,
				it&apos;s best to lookup the associated wagmi connector and pass it as
				an argument to the hook or method call.
				<br />
